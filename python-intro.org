...
** TODO http://matlab.cheme.cmu.edu/2011/10/14/the-trapezoidal-method-of-integration/
...
plt.ylabel('$f_F$')
plt.legend()
plt.savefig('smooth-transitions-1.png')
#+END_SRC
...
plt.savefig('smooth-transitions-sigma.png')
#+END_SRC
...
plt.ylabel('$f_F$')
plt.legend()
plt.savefig('smooth-transitions-3.png')
#+END_SRC
...
plt.savefig('smooth-transitions-morrison.png')
#+END_SRC
...
#+RESULTS:
: 
: >>> >>> >>> >>> >>> >>> [<matplotlib.lines.Line2D object at 0x04BD4890>]
: <matplotlib.text.Text object at 0x04AF6A70>
: <matplotlib.text.Text object at 0x04BAFB10>
...
You can see that the R^2 value is not better than the one from a linear fit,  so adding a parameter does not increase the goodness of fit. This is an example of overfitting the data, but it also makes you question whether the constant is meaningful in the linear model. 
...
#+RESULTS:
: 
: >>> >>> >>> >>> <matplotlib.figure.Figure object at 0x0519BFB0>
: [<matplotlib.lines.Line2D object at 0x0524AA50>, <matplotlib.lines.Line2D object at 0x052400B0>]
: <matplotlib.text.Text object at 0x051ABB70>
: <matplotlib.text.Text object at 0x05227A30>
: <matplotlib.legend.Legend object at 0x05253190>
: >>> >>> >>> >>> >>> <matplotlib.text.Text object at 0x052403B0>
...
** TODO http://matlab.cheme.cmu.edu/2011/09/04/random-thoughts/
* Data analysis
** Linear regression
...
** TODO http://matlab.cheme.cmu.edu/2011/10/27/compute-pipe-diameter/
...
---
layout: post
title: Integrating the batch reactor mole balance
tags:
...
plt.show()][last post]] of evaluating an integral is to integrate a differential equation. For the batch reactor, the differential equation that describes conversion as a function of time is:
...
[[./images/013-01-06-batch-conversion.png]]

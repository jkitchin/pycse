...
# user we started as.
    ...
    # Added by JRK [2022-06-26 Sun] for intel compilers
    source /home/jovyan/intel/oneapi/setvars.sh
    source /home/jovyan/intel/oneapi/compiler/2022.1.0/env/vars.sh
    source /home/jovyan/intel/oneapi/mpi/2021.6.0/env/vars.sh
    ulimit -s unlimited
    exec "${cmd[@]}"
fi

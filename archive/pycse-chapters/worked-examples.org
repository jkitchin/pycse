...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/6197d397b6866698cdf86938af151eebeaa75982.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/1962a6d5fa89e0a0565becc8276ffc2142849ace.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/c34833ec102d89b5d40057a864b9c0714f78ebdb.png]]
:END:
...
[[file:./.ob-jupyter/8ef8a04214446d1c3074dae369e676b924fceb9b.png]]
[[file:./.ob-jupyter/ba05c22fa3cdebf8a14b5c12b2ce3f0b4099b00c.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/b8b4b72ad5a722abc9b2bd7d201783d8334273b1.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/3a9a6a4757fe5448e6b37cec7d07cef06f9efa44.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/1073a869d2ec8ec545ef425a9f042a5ce1b0f68b.png]]
:END:
...
[[file:./.ob-jupyter/91d3bdbb4899fa9dead690c6d8db0f5e92ae8c00.png]]
:END:
...
[[file:./.ob-jupyter/3a9a361f86d5576cd20cc5db9b8d22cd25f47e5a.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/62688e4dd4e0cf535e1fae60e169c8c93dd3e2a9.png]]
:END:
...
True
/var/folders/3q/ht_2mtk52hl7ydxrcr87z2gr0000gn/T/ipykernel_15573/1892264215.py:6: RuntimeWarning: invalid value encountered in log
  G = np.sum(nj * (Gjo / R / T + np.log(nj / Enj)))
:END:
...
#+RESULTS:
:RESULTS:
/var/folders/3q/ht_2mtk52hl7ydxrcr87z2gr0000gn/T/ipykernel_15573/2870202885.py:20: RuntimeWarning: divide by zero encountered in log
  diffg += R * T * x1 * np.log(x2 * P / P0)
/var/folders/3q/ht_2mtk52hl7ydxrcr87z2gr0000gn/T/ipykernel_15573/2870202885.py:20: RuntimeWarning: invalid value encountered in multiply
  diffg += R * T * x1 * np.log(x2 * P / P0)
[[file:./.ob-jupyter/6101cd2212987620fa88dc3429f62033e816a49b.png]]
:END:
...
/var/folders/3q/ht_2mtk52hl7ydxrcr87z2gr0000gn/T/ipykernel_15573/2870202885.py:20: RuntimeWarning: invalid value encountered in multiply
  diffg += R * T * x1 * np.log(x2 * P / P0)
[[file:./.ob-jupyter/4a8159e8ce396361b4a724cc6ae552f7fca61e67.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/23489bc0f36440b3bf571298c0e6b0517c401765.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/dcd8a7ec845ef20aa7d1cfbfab43849ba10ce7c7.png]]
:END:
...
-2.5594238377522345
/var/folders/3q/ht_2mtk52hl7ydxrcr87z2gr0000gn/T/ipykernel_15573/1928982228.py:17: RuntimeWarning: invalid value encountered in log
  d * np.log(P) + yI * d * np.log(yI) +
/var/folders/3q/ht_2mtk52hl7ydxrcr87z2gr0000gn/T/ipykernel_15573/1928982228.py:18: RuntimeWarning: invalid value encountered in log
  yB * d * np.log(yB) + yP1 * d * np.log(yP1) + yP2 * d * np.log(yP2))
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/42f1381c04eff5279bb6a73bfce7585185682b26.png]]
:END:
...
0.5630113483142608
0.5630033628012618
[[file:./.ob-jupyter/2a9e650f47260588a2aab1857444f1311b1ee209.png]]
:END:
...
[[file:./.ob-jupyter/ac8cedc30a63c3e34a560aa84fafb6f753e4ffbe.png]]
:END:
...
:RESULTS:
: Text(0, 0.5, '$P_R$')
[[file:./.ob-jupyter/560aa58fe263c86fe68d6a2d73b579e13de33ebe.png]]
:END:
...
#+RESULTS:
:RESULTS:
| <matplotlib.lines.Line2D | at | 0x11fba1330> |
[[file:./.ob-jupyter/19d58b622291607576218d81dbce21d2702530c3.png]]
:END:
...
[[file:./.ob-jupyter/721ded8c38c44900bdfed27d9fc2b053ae8cb227.png]]
:END:
...
#+RESULTS:
:RESULTS:
/Users/jkitchin/anaconda3/lib/python3.10/site-packages/numpy/core/shape_base.py:65: VisibleDeprecationWarning: Creating an ndarray from ragged nested sequences (which is a list-or-tuple of lists-or-tuples-or ndarrays with different lengths or shapes) is deprecated. If you meant to do this, you must specify 'dtype=object' when creating the ndarray.
  ary = asanyarray(ary)
# [goto error]
---------------------------------------------------------------------------
ValueError                                Traceback (most recent call last)
...
File ~/anaconda3/lib/python3.10/site-packages/scipy/optimize/_minpack_py.py:240, in _root_hybr(func, x0, args, jac, col_deriv, xtol, maxfev, band, eps, factor, diag, **unknown_options)
    238     if maxfev == 0:
    239         maxfev = 200 * (n + 1)
...
NameError: name 'y_eq' is not defined
[[file:./.ob-jupyter/7676837ece18aa095d081b323e3ec8c3101aa8cd.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/8af0e14a3e886048e808f3e72dd9c048eb66a246.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/87269b76abec09c7481958741b9928ebdb90ca8a.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/41bb433daae3777e806ce5876376f4eeb4d99a1e.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/173f65851dd5548523759e2bbe2337ad3dbf25c4.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/9ae0df782395bd54d3c5de2fe44c0c301fc72dee.png]]
:END:
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/b0e9e5f10ec8219cf0ef7b4a547518fb523caf6a.png]]
:END:
...
#+RESULTS:
:RESULTS:
/var/folders/3q/ht_2mtk52hl7ydxrcr87z2gr0000gn/T/ipykernel_15573/339476128.py:64: RuntimeWarning: invalid value encountered in double_scalars
  m1 = y1 / x1
/var/folders/3q/ht_2mtk52hl7ydxrcr87z2gr0000gn/T/ipykernel_15573/339476128.py:64: RuntimeWarning: divide by zero encountered in double_scalars
  m1 = y1 / x1
[[file:./.ob-jupyter/ccef25831a6a887a8196159d169af96df2a7de17.png]]
:END:
